...
*   adj is the adjacency list of the undirected graph, since we have also to use the reversed 
...
*   The value of the flow in each edge will actually not be stored, but it is easy to extend the implementation - 
*   by using an additional matrix - to also store the flow and return it.
*/
